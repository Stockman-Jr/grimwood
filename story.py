...
HOUSE = (Fore.CYAN + """
    ...
    You wonder what whomever was here was writing about, but it seems
...
HOUSE_ITEM = (Fore.CYAN + """
    ...
    handle, you've never seen anything like it.

    There's some kind of switch on the back, you turn it and incredibly
    enough, it works!
...
SOUTH_SURVIVAL = (Fore.RED + """
    ...
    You looked back at the woods once more and saw the creature, watching.
